...
interface Soar{
    ...
    void fly(int speed);                    // Belirtilmesede varsayılan olarak public abstract'tır.
 ...
 * Abstract class'lar ve Interfaceler ikiside abstract tipler olarak bildirilmektedir. Sadece interface'lerde implicit modifier'lar yer alır.
